...
model=Learning(path=os.path.join(APP_dir,"model/Learning_test_model"), inputs=inputs, outputs=outputs, device=device, batch_size=batch_size, lr=0.01, epochs=100)
end=time.time()
time_diff = end - start
print(time_diff)
